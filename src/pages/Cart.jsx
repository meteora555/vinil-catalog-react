...
import { clearAll, removeCartItem, plusCartItem, minusCartItem } from '../redux/actions/cart';
...
function Cart() {
  ...
  const adedVinils = Object.keys(items).map((key) => {
        ...
        <div className="cart_container">
          ...
          <div className="cart__bottom">
            ...
            <div className="cart__bottom-buttons">
              <Link to="/">
                <div className="cart__bottom-gobackbtn">
                  <svg
                    width="8"
                    height="14"
                    viewBox="0 0 8 14"
              ...
              <a href="/" className="cart__bottom-paybtn">
